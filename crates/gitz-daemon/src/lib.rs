...
use gitz_storage::{MetadataStore, RepoMetadata};
use gitz_watch::{
...
mod tests {
    use super::*;
    use git2::Repository;
    use gitz_storage::InMemoryMetadataStore;
    use gitz_watch::{ManualWatchHandle, ManualWatcher, WatchEvent, WatchEventKind};
